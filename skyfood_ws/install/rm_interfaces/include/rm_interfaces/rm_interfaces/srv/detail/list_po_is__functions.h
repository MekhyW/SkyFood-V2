...
#ifndef RM_INTERFACES__SRV__DETAIL__LIST_PO_IS__FUNCTIONS_H_
#define RM_INTERFACES__SRV__DETAIL__LIST_PO_IS__FUNCTIONS_H_
...
/// Initialize srv/ListPOIs message.
/**
...
/// Create srv/ListPOIs message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rm_interfaces__srv__ListPOIs_Request__init().
...
/// Destroy srv/ListPOIs message.
/**
 * It calls
 * rm_interfaces__srv__ListPOIs_Request__fini()
...
/// Check for srv/ListPOIs message equality.
/**
...
/// Initialize array of srv/ListPOIs messages.
/**
...
/// Finalize array of srv/ListPOIs messages.
/**
 * It calls
 * rm_interfaces__srv__ListPOIs_Request__fini()
...
/// Create array of srv/ListPOIs messages.
/**
 * It allocates the memory for the array and calls
 * rm_interfaces__srv__ListPOIs_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ListPOIs messages.
/**
 * It calls
 * rm_interfaces__srv__ListPOIs_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ListPOIs message array equality.
/**
...
/// Copy an array of srv/ListPOIs messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rm_interfaces__srv__ListPOIs_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_interfaces
...
/**
 * It calls
 * rm_interfaces__srv__ListPOIs_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * rm_interfaces__srv__ListPOIs_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_interfaces
...
/**
 * It calls
 * rm_interfaces__srv__ListPOIs_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RM_INTERFACES__SRV__DETAIL__LIST_PO_IS__FUNCTIONS_H_
